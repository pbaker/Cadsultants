...
{
	if(num_pages != 2)
	        plotxy((int)(x/res_factor),(int)(y/res_factor));
	else
	        plotxy((int)(x/res_factor),(int)((y + which_page*768)/
			res_factor));
}
...
{
	if(num_pages != 2)
		lincir((int)(x/res_factor),(int)(y/res_factor),
			(int)(radius/res_factor));
	else
		lincir((int)(x/res_factor),(int)((y + which_page*768)/
			res_factor),(int)(radius/res_factor));
}
...
/*sets version_str[] for displaying version# & date*/
	...
	switch(port_byte)
	{
		case 0x03 :
		{
			sprintf(board_string,"Artist 10E  640 x 480");
			num_pages = 2;
			rotate_mode = 'm';
			break;
		}
		...
		case 0x0f :
		{
			sprintf(board_string,"Artist 10  640 x 480");
			num_pages = 2;
			rotate_mode = 'm';
			break;
		}
		...
		case 0x0c :
		{
			sprintf(board_string,"Artist 10/16  640 x 480");
			num_pages = 1;
			rotate_mode = 'm';
			break;
		}
...
int temp_y1;
	...
	if(my_which_page == SVWPT_PAGE_1)
		svwpt(0,0,(int)(1023/res_factor),(int)(767/res_factor));
	else
	{
		if(num_pages == 2)
		{
			if(my_which_page == 2)    /*both pages*/
				svwpt(0,0,(int)(1023/res_factor),
					(int)((767 + 768)/res_factor));
			else
				svwpt((int)(x1/res_factor),(int)((y1 + 
					my_which_page*768)/res_factor),
					(int)(x2/res_factor),
					(int)((y2 + my_which_page*768)/
					res_factor));
		}
		else
			svwpt((int)(x1/res_factor),(int)(y1/res_factor),
				(int)(x2/res_factor),(int)(y2/res_factor));
	}
}
...
{
	if(num_pages == 2)
		scrola(0,(int)(my_which_page*768/res_factor + 0.5));
	else
		scrola(0,0);
}
...
int x1,y1,x2,y2;
{
	if(num_pages == 2)
	{
		linxy((int)(x1/res_factor),(int)((y1 + which_page*768)/
			res_factor),(int)(x2/res_factor),
			(int)((y2 + which_page*768)/res_factor));
	}
	else
		linxy((int)(x1/res_factor),(int)(y1/res_factor),
			(int)(x2/res_factor),(int)(y2/res_factor));
}
...
int my_which_page;
{
	...
	{
		if(my_which_page == 2)     /*both pages*/
			clrwrd(0,0,(int)(1023/res_factor),(int)((767 + 768)/
				res_factor),0);
		else
			clrwrd(0,(int)(my_which_page*768/res_factor),
				(int)(1023/res_factor),
				(int)((767 + 768*my_which_page)/res_factor),0);
	}
	else
		clrwrd(0,0,(int)(1023/res_factor),(int)(767/res_factor),0);
}
...
/*right now   128 <= x <= 896   &    128 <= y <= 896   So y inversion uses 896*/
	...
	schar(ch,(int)(x1/res_factor),(int)(y1/res_factor) - 4,rot);
}
