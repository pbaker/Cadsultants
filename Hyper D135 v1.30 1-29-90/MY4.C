...
int far initial_joy_count = 700;


/* for pan box movement scaling calculation */
short far read_3d_viewing_matrix[16];

void far joystick();



void far display_locate_seg(old_new)
int old_new;
{
	save_my_x = my_x;
	save_my_y = my_y;
...
void far display_the_curser(old_new)
int old_new;
{
	save_my_x = my_x;
	save_my_y = my_y;
...
char far only_two_segments_visible()
{
int i,visi_count;
