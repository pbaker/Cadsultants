...
char far pixel_listing_buffer[200] = "\0";
short far text_monitor_dl[22222];
short far *text_dl_pointer = &text_monitor_dl[0];



void far clear_text_monitor_dl()
{
