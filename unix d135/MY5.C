...
char  char_last_word_full = 'f';
char  gtext_string[200];


void  cap_P_func(sub_count,which_subr) /*move 2D absolute*/
...
void  cap_R_func(sub_count,which_subr) /*move 2D relative*/
int *sub_count,which_subr;
{
	diag_num = 49;
	read_more(4);
...
void  cap_Y_func(sub_count,which_subr) /*short relative vectors*/
int *sub_count,which_subr;
{
...
void  cap_Q_func(sub_count,which_subr) /*draw 2D absolute*/
int *sub_count,which_subr;
{
	diag_num = 51;
...
void  cap_S_func(sub_count,which_subr) /*draw 2D relative*/
int *sub_count,which_subr;
{
	diag_num = 52;
...
void  cap_X_func(sub_count,which_subr) /*use charactor string*/
int *sub_count,which_subr;
{
int i,j,start_loop;
long current_pos;
...
void  cap_T_func(sub_count,which_subr) /*move 3D absolute*/
int *sub_count,which_subr;
{
	read_more(6);
...
void  cap_U_func(sub_count,which_subr)  /*draw 3D absolute*/
int *sub_count,which_subr;
{
	read_more(6);
...
void  cap_V_func(sub_count,which_subr) /*move 3D relative*/
int *sub_count,which_subr;
{
	read_more(6);
...
void  cap_W_func(sub_count,which_subr) /*draw 3D relative*/
int *sub_count,which_subr;
{
	read_more(6);
