...
{
	schar(the_char,(int)(x/res_factor),(int)(y/res_factor),rotate);
}
...
double angle,delta_angle;
	...
	for(angle = 0.0 ; angle <= 6.29 ; angle += delta_angle)
		plotxy((int)(INDIC_RADIUS*cos(angle) + x/res_factor),
			(int)(INDIC_RADIUS*sin(angle) + y/res_factor));
}
